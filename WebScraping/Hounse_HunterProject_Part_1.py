<<<<<<< HEAD:Projects/WebScraping/Hounse_HunterProject_Part_1.py
##Modules##
import csv
import requests
...
website_source='https://www.redfin.com/city/10201/NV/Las-Vegas/filter/property-type=house+multifamily,min-price=300k,max-price=350k,min-beds=2,min-baths=1.5,status=active,viewport=36.30994:35.89273:-114.82616:-115.61786'
#website_source='https://www.redfin.com/city/16657/TX/San-Antonio/filter/property-type=house,min-price=125k,max-price=500k,min-beds=2,min-baths=1.5,min-parking=1,status=active,exclude-age-restricted,viewport=29.7348:29.17038:-98.09509:-98.94104,no-outline,financing-type=VA'
def page_request(url):
    ...
    '''show this output to class'''
#    print(soup)
#    pprint(soup)   
        # This is jibberish but we can still use it
    '''in Google Chrome use developer tools to identify what we want'''
#    helper.timeout(20)
...
#collect and store the useable data in a dictionary
    #This dictionary is used once and replaced with every iteration, the format is more important here.
    Home={
...
#link to the individual page        
        ...
        page+=1
        source=website_source+'/page-'+str(page)
...
>>>>>>> d5044abfad8f836a7d2f8b942446d6797e08c3b5:WebScraping/Hounse_HunterProject_Part_1.py
'''